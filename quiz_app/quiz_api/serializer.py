...
#         fields = ['subject','id','question_name','op1','op2','op3','op4']
    ...
    #     get_subject_name =self.context.get('subject_name')
    #     return reverse('question-list',get= {"subject_name":get_subject_name}, kwargs={"question_id":instance.id})




class QuestionListSerializer(serializers.ModelSerializer):
    # url = serializers.HyperlinkedIdentityField(view_name='question-list', read_only=True)
    subject = SubjectListSerializer()   
    class Meta:
        model = Question
        fields = ['subject','id','question_name','op1','op2','op3','op4']
